...
(defn get-all-entities
  ...
  Not that useful in application, but good for debugging/testing"
  [system]
...
(defmulti get-component-type
          "Returns the type for a given component.
          Using a multimethod with 'class' as the dispatch-fn
          to allow for extensibility per application.
...
(defn update-component
  "Update an entity's component instance through through fn.
  Function is applied first with the specified component and any other args applied,
  and should return the modified component instance.
  Return nil if you want no change to occur."
